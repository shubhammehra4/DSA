...
/*------------------------------------------------------------------------------------------------------*/
// https://www.codechef.com/START15C/problems/INTCONCA
#define concatenate(x, y) (((x)*power(10, (log10(y) + 1))) + (y))
...
void solve()
{
    ...
    {
        int leny = log10(y) + 1;
        int d = power(10LL, leny); // Denominator
        int L = (l - y + d - 1LL) / d;
        int R = (r - y) / d;

        ans += uprb(arr, R) - lowb(arr, L);
    }
